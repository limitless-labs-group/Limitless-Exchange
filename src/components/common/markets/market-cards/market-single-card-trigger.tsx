...
import { MarketSingleCardProps } from './market-single-card'
...
export const SingleCardTrigger = React.memo(({ market, markets }: MarketSingleCardProps) => {
...
SingleCardTrigger.displayName = 'DailyCardTrigger'
