...
export const markets: Market[] = [
  {
    ...
    placeholderURI: '/assets/images/markets/market6-placeholder.jpg',
    imageURI: '/assets/images/markets/market6.jpg',
    ogImageURI: 'https://limitless.exchange/assets/images/markets/market6-og.jpg',
    expirationDate: 'TBA',
    expirationTimestamp: 1717189199000,
    expired: Date.now() > 1717189199000, // TODO: make dynamic
    creator: {
      name: '@AutismCapital',
      imageURI: '/assets/images/markets/autism-capital.jpg',
