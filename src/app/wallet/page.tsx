...
const WalletPage = () => {
  ...
  const [selectedToken, setSelectedToken] = useState<Address>('0x')
      ...
      <Paper>
        ...
        <Accordion allowMultiple mt='16px'>
          ...
          <AccordionItem>
            ...
            <AccordionPanel pb={4} px={{ md: 2 }}>
              Because ETH was deployed prior to the erc20 standard, it is not an erc20 token & needs
              to be “wrapped” in order to be traded with other tokens. When you deposit ETH into
              your smart account, it will be wrapped. If you already have some WETH, you can send it
              to your account address in the same way.
            </AccordionPanel>
          </AccordionItem>
          <AccordionItem>
            <h2>
